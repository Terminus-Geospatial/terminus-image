...
ImageResult<std::vector<Interest_Point>> detect_interest_points( const image::Image_Base<ImageT>&  image,
...
*/
template <typename ImageT>
ImageResult<void> detect_interest_points( image::Image_Base<ImageT>&    image,
