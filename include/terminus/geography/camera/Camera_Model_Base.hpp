 ...
 * an ImageResult with an error-code of Not-implemented.
 * 
...
class Camera_Model_Base
{
    public:
         ...
         */
        virtual ImageResult<math::Point2d> point_to_pixel( const math::Point3d& point ) const = 0;
         ...
         * sensor.  
         */
        virtual ImageResult<math::Vector3d> pixel_to_vector( const math::Point2d& pixel ) const = 0;
         ...
         */
        virtual ImageResult<math::Point3d> camera_origin( const math::Point2d& pixel ) const = 0;
         ...
         */
        virtual ImageResult<math::Quaternion> camera_pose( const math::Point2d& pixel ) const;
