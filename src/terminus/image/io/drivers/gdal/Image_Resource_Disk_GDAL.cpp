...
/****************************************************/
ImageResult<Image_Resource_Disk_GDAL::ParentPtrT>
...
/*          Open the dataset        */
/************************************/
ImageResult<void> Image_Resource_Disk_GDAL::open( const std::filesystem::path& pathname )
{
...
/****************************************************/
ImageResult<void> Image_Resource_Disk_GDAL::write( const Image_Buffer& source_buffer,
